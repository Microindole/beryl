//! Lency Code Generation
//!
//! LLVM 代码生成模块，将 Lency AST 转换为 LLVM IR
//!
//! # 架构
//!
//! 模块化设计，遵循开闭原则：
...
/// 编译 Lency 程序为 LLVM IR
///
/// # Arguments
/// * `program` - Lency AST 程序
/// * `module_name` - 模块名称
///
/// * `source` - 源代码 (可选)
///
...
/// 编译 Lency 程序为 LLVM Module（用于进一步处理）
///
/// # Arguments
/// * `program` - Lency AST 程序
